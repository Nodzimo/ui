...
| `lucide-react`             | https://github.com/lucide-icons/lucide              | React icon component exports, package format, tree-shaking behavior, icon naming changes used by local components and stories.            |
