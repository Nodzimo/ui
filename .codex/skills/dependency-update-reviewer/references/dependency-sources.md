...
| `@biomejs/biome`              | https://github.com/biomejs/biome, https://biomejs.dev                                                                             | Formatter/linter rule changes, Tailwind class sorting, JSON strictness, config schema changes.                   |
...
| `@storybook/addon-onboarding` | https://github.com/storybookjs/storybook, https://storybook.js.org/docs                                                           | Generated onboarding/demo behavior. Low project importance unless scripts/config reference it.                   |
...
| `unplugin-dts`                | https://github.com/qmhc/unplugin-dts                                                                                              | Declaration generation, `tsconfigPath`, package export type paths, Vite library build integration.               |
